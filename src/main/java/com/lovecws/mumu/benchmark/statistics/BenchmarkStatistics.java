...
package com.lovecws.mumu.benchmark.statistics;
...
public class BenchmarkStatistics {
    ...
    public BenchmarkStatistics(List<RunnableStatistics> statistics) {
    ...
    public void printStatistics() {
        ...
        if(allTPS==0)allTPS=1;
        if(statisticTime==0)statisticTime=1;
